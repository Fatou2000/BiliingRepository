...
public class FactureResource {
    ...
    public ResponseEntity<FactureDTO> updateFacture(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, factureDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<FactureDTO> partialUpdateFacture(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, factureDTO.getId())
        );
    }
