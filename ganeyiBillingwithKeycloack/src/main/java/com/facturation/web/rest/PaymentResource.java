...
public class PaymentResource {
    ...
    public ResponseEntity<PaymentDTO> updatePayment(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, paymentDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<PaymentDTO> partialUpdatePayment(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, paymentDTO.getId())
        );
    }
