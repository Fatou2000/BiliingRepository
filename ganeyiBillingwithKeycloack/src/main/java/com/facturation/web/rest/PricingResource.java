...
public class PricingResource {
    ...
    public ResponseEntity<PricingDTO> updatePricing(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, pricingDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<PricingDTO> partialUpdatePricing(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, pricingDTO.getId())
        );
    }
