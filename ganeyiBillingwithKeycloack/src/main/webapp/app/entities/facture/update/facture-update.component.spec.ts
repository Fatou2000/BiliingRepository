...
describe('Facture Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call Product query and add missing value', () => {
      const facture: IFacture = { id: 'CBA' };
      const products: IProduct[] = [{ id: 'ba206778-db4e-4f8e-aaea-38bd0781440b' }];
      facture.products = products;

      const productCollection: IProduct[] = [{ id: '11770717-c4b8-4548-8393-a07deeb41ccd' }];
    ...
    it('Should update editForm', () => {
      ...
      facture.client = client;
      const product: IProduct = { id: '654a87a7-cd1b-42e6-a668-f0755523c128' };
