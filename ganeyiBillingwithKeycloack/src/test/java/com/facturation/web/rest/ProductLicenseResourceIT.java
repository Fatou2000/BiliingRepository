...
class ProductLicenseResourceIT {
    ...
    void createProductLicense() throws Exception {
        ...
        ProductLicenseDTO productLicenseDTO = productLicenseMapper.toDto(productLicense);
        restProductLicenseMockMvc
            .perform(
                post(ENTITY_API_URL)
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(productLicenseDTO))
            )
    ...
    void putExistingProductLicense() throws Exception {
        ...
        updatedProductLicense
            ...
            .endDate(UPDATED_END_DATE)
            .isActive(UPDATED_IS_ACTIVE);
        ProductLicenseDTO productLicenseDTO = productLicenseMapper.toDto(updatedProductLicense);

        restProductLicenseMockMvc
            .perform(
                put(ENTITY_API_URL_ID, productLicenseDTO.getId())
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(productLicenseDTO))
            )
    ...
    void patchNonExistingProductLicense() throws Exception {
        ...
        restProductLicenseMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, productLicenseDTO.getId())
                    .with(csrf())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(productLicenseDTO))
            )
    ...
    void deleteProductLicense() throws Exception {
        ...
        restProductLicenseMockMvc
            .perform(delete(ENTITY_API_URL_ID, productLicense.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
